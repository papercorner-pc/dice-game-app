...
import { createGame, editGame } from '../../../services/game/game';
...
const EditContest = props => {
    ...
    const onEditContest = () => {
        ...
        if (parseInt(entryLimit) < parseInt(game.entry_limit)) {
            isValid = false;
        ...
        <SafeScreen>
            <View style={{ flexDirection: 'row', height: 48 }}>
                ...
                <View style={styles.mainHeadingContainer}>
                    <Text style={styles.headingText}>Edit Contest</Text>
                </View>
            </View>
            <ScrollView>
                <View
